...
class FollowupManualReminder(models.TransientModel):
    _name = 'cjg_finance.manual_reminder'
    ...
    email_recipient_ids = fields.Many2many(string="Extra Recipients", comodel_name='res.partner',
                                           relation='rel_followup_manual_reminder_sale_credit_followup',
                                           column1='manual_reminder_id',
                                           column2='partner_id')  # override
    ...
    def _compute_body(self):
        ...
        for wizard in self:
            ...
            wizard.body = self.env['credit.followup.report']._get_main_body(options)
    ...
    def _compute_body_html(self):
        ...
        for wizard in self:
            ...
            wizard.body_html = self.env['credit.followup.report']._get_main_body(options)
    ...
    def _compute_sms_body(self):
        for wizard in self:
            ...
            wizard.sms_body = self.env['credit.followup.report']._get_sms_body(options)
